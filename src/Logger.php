...
namespace Abrahamyanvaxik\LaravelLoggable;

use Abrahamyanvaxik\LaravelLoggable\Events\Logged;
use Abrahamyanvaxik\LaravelLoggable\Exceptions\LoggableFieldsNotSetException;
...
class Logger
{
    ...
    public function __construct($model, $action)
    {
        ...
        $this->driver->file = new \Abrahamyanvaxik\LaravelLoggable\Drivers\File(
            $this->model, $this->action, $this->config, $this->user, $this->loggable_fields
        );
        $this->driver->database = new \Abrahamyanvaxik\LaravelLoggable\Drivers\Database(
            $this->model, $this->action, $this->config, $this->user, $this->loggable_fields
        );
